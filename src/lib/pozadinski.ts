...
import { odrzavanje } from "@/services/opasna-zona";
import { db } from "./db";

let pokrenuto = false;

/** Svake minute: naknadna dostava računa CIS-u; svakih sat vremena eIzvještavanje, čišćenje isteklih sesija i dnevne sigurnosne kopije (poslije 02:00). Greška jednog kruga ne zaustavlja sljedeće. */
